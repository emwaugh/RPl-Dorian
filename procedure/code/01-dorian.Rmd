...
```
Separate analysis into two time periods for additional comparison. 
...
# Network Analysis
**EMMA redesign this plot using link on lab page for Nov 18 & Kara notes, also write_graph to save**
...
ndti <- ggplot() +
  ...
  labs(title = "Increased Discussion of Hurricanes on Twitter During Hurricane Ida") +
  theme(
    plot.title = element_text(hjust = 0.5),
    axis.title.x = element_blank(),
    axis.title.y = element_blank()
