...
```
**EMMA clean up the following sections**
# Pre-processing
...
```{r search-snow, eval = FALSE}
snow_raw <- search_tweets("first snow OR snow OR snowfall",
  n = 200000, include_rts = FALSE,
  token = twitter_token,
  geocode = "40,-98,1500mi",
  retryonratelimit = TRUE
)

# write status id's for results of the original twitter search
write.table(snow_raw$status_id,
  here("data", "raw", "public", "snowids.txt"),
...
``` 
**EMMA change these to the raw data file links**
...
# Network Analysis
**EMMA redesign this plot using link on lab page for Nov 18**
...
**EMMA make an NDTI plot and maybe some plots at smaller geographic scale? maybe LA and NY?**
